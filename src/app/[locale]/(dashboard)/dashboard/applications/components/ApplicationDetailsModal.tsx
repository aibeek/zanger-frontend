				...
				<div className={s.content}>
					...
					<div className={s.metaInfo}>
						<div className={s.metaRow}>
							...
							<span className={s.metaValue}>{app.user?.name || 'Клиент'}</span>
						</div>
						<div className={s.metaRow}>
							<span className={s.metaLabel}>{t('region')}:</span>
							<span className={s.metaValue}>{derivedRegion || 'Не указан'}</span>
						</div>
						<div className={s.metaRow}>
							<span className={s.metaLabel}>Телефон:</span>
							<span className={s.metaValue}>{derivedPhone || 'Не указан'}</span>
						</div>
						<div className={s.metaRow}>
							<span className={s.metaLabel}>Язык обращения:</span>
							<span className={s.metaValue}>{derivedLang || 'Не указан'}</span>
						</div>
						<div className={s.metaRow}>
