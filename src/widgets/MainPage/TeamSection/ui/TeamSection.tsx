...
Жилищно-коммунальные споры.`,
    ...
    },
    {
      ...
      name: 'Жанел Қоқымбай',
      position: 'Юридический консультант',
      experience: 'Юридический опыт более 7 лет.\nОпыт в правоохранительных органах более 5 лет.',
      moreExperience:
        'Основные направления деятельности:\n\n• Защита по уголовным делам, включая представление интересов подозреваемых, обвиняемых и потерпевших\n• Представление интересов доверителей на всех стадиях уголовного, гражданского и административного процесса\n• Брачно-семейные, жилищные споры\n• Взыскание материального и морального вреда, в том числе при ДТП\n• Возврат денежных средств по мошенническим схемам, инвестиционным и криптооперациям\n• Взыскание неосновательного обогащения\n• Наследственные и имущественные дела\n• Обжалование судебных актов',
      description:
        'Уголовное право, гражданское право, административное право, семейное и трудовое право',
      image: '/assets/images/jenis.jpeg',
    },
    {
      id: 24,
      name: 'Назарбек Игиликов',
      position: 'Юридический консультант',
      experience: 'Профессиональный опыт более 25 лет',
      moreExperience:
        'Опыт работы:\n\n• 2000 г. — Суд города Астаны, специалист.\n• 2001 г. — Верховный Суд Республики Казахстан, специалист.\n• 2002–2005 гг. — Специализированный межрайонный экономический суд Актюбинской области, судья.\n• 2005–2007 гг. — Аулиекольский районный суд Костанайской области, председатель суда.\n• 2007–2011 гг. — Костанайский областной суд, судья.\n• 2011–2022 гг. — Карасайский районный суд Алматинской области, судья.\n• 2022–2025 гг. — Главная палата юридических консультантов Алматинской области, юридический консультант.',
      description:
        'Гражданское право, семейное право, АППК, земельное право',
      image: '/assets/images/nazarbek.png',
    },
    {
      id: 25,
      name: 'Асель Ташенова',
      position: 'Юрист, медиатор',
      experience: 'Опыт работы в судебной и банковской системах более 20 лет.',
      moreExperience:
        'Являюсь частнопрактикующим юристом во всех отраслях права. Имею сертификат профессионального медиатора с 2017 года.',
      description:
        'Гражданское право, трудовое право, административное право, земельное право',
      image: '/assets/images/tashenova.png',
    },
    {
      id: 26,
      name: 'Еркебұлан Қайратұлы',
      position: 'Адвокат',
      experience: 'Общий юридический стаж более 10 лет',
      moreExperience:
        'Адвокат с профессиональным опытом работы следователем в МВД.\nСпециализируюсь по уголовным делам:\n• Глубокое знание следственных процедур\n• Умение находить слабые места в обвинении\n• Грамотное построение линии защиты\n• Быстрое реагирование в кризисных ситуациях\n• Предоставляю срочную юридическую помощь 24/7, выезд при задержании, сопровождение на допросах, защита на стадии следствии и суда\n• ДТП, взыскание морального, материального ущерба и страховых выплат\n\nИ сложных гражданских спорах:\n• Бракоразводный процесс, раздел имущества, алименты\n• Банковские споры, снятие арестов, составление графика, реструктуризация кредитов\n• Наследственные дела\n• Трудовые споры\n• Взыскание задолженности и т.п.\n\nКонсультация бесплатная в случае составления договора об оказании юридических услуг.',
      description:
        'Уголовное право, гражданское право, административное право, трудовое право, ДТП, исполнительное производство',
      image: '/assets/images/erkebulan.jpeg',
    },
    {
      id: 27,
      name: 'Зоя Мухаметова',
      position: 'Адвокат',
      experience: 'Профессиональный опыт более 12 лет',
      moreExperience:
        'Предоставляю квалифицированную юридическую помощь по широкому спектру правовых вопросов: консультации, защита и представительство на предварительном следствии, участие в судебных разбирательствах, претензионно-исковая работа.\n\n• Гражданские дела — договорные споры, защита прав потребителей, семейное право, наследственные дела и т. п.\n• Уголовные дела — защита подозреваемых и обвиняемых, представительство в суде\n• Дела об административных правонарушениях — защита по делам об административных правонарушениях\n• Административные дела в СМАС — обжалование актов административных органов, оспаривание решений в системе административного судопроизводства\n• Банкротство физических лиц\n• Прочее',
      description:
        'Гражданское право, уголовное право, административное право, исполнительное производство',
      image: '/assets/images/zoya.jpeg',
    },
    {
      id: 28,
      name: 'Фатима Кармазина',
      position: 'Юридический консультант. Медиатор.',
      experience: 'Стаж работы более 20 лет.',
      moreExperience:
        'Сопровождение бизнеса, работа с государственными органами. Опыт работы — многолетняя юридическая практика, включая государственную службу. Сложные дела, успешные решения в судах разных инстанций, защита интересов клиентов с реальным результатом.',
      description:
        'Корпоративное, гражданское, семейное право и т.д.',
      image: '/assets/images/fatima.jpeg',
    },
  ]
