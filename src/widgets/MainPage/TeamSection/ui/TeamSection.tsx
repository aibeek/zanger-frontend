...
Жилищно-коммунальные споры.`,
    ...
    {
      id: 10,
      name: 'Жапарова Салтанат',
      position: 'Юрист, международный медиатор',
      experience: 'Опыт: более 16 лет',
      moreExperience:
    ...
    {
      id: 21,
      name: 'Баймурзин Адильбек',
      position: 'Юридический консультант',
      experience: 'Опыт: более 11 лет',
      moreExperience:
    ...
    {
      id: 24,
      name: 'Игиликов Назарбек',
      position: 'Юридический консультант',
      experience: 'Опыт: более 25 лет',
      moreExperience:
  ...
  const visibleMembers = useMemo(
    () => teamMembers.slice(page * cardsPerPage, page * cardsPerPage + cardsPerPage),
    [page, cardsPerPage]
  )
  ...
  useEffect(() => {
    ...
    const updateCardsPerPage = () => {
      ...
      if (w <= 560) setCardsPerPage(CARDS_PER_PAGE_SMALL)
      else if (w <= 900) setCardsPerPage(CARDS_PER_PAGE_MOBILE)
      else if (w <= 1200) setCardsPerPage(CARDS_PER_PAGE_TABLET)
      else setCardsPerPage(CARDS_PER_PAGE_DESKTOP)
    }
  ...
  const goForward = useCallback(() => setPage((p) => Math.min(totalPages - 1, p + 1)), [totalPages])
          ...
          {totalPages > 1 && (
            <div className={s.paginationDots}>
              {Array.from({ length: totalPages }).map((_, i) => (
                <button
                  key={i}
                  className={`${s.paginationDot} ${i === page ? s.active : ''}`}
                  onClick={() => setPage(i)}
      ...
      {mounted && isModalOpen && selectedMember &&
        createPortal(
          ...
          >
            ...
            >
              <button className={s.modalCloseBtn} onClick={closeModal} aria-label="Закрыть">
                &times;
              </button>
                  ...
                  {showContactIcons && (
                    <div className={s.headerContacts}>
                      <div className={s.contactIconOnly}>
                        <svg className={s.whatsappIcon} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div className={s.contactIconOnly}>
                        <svg className={s.phoneIcon} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07 19.5 19.5 0 01-6-6 19.79 19.79 0 01-3.07-8.67A2 2 0 014.11 2h3a2 2 0 012 1.72 12.84 12.84 0 00.7 2.81 2 2 0 01-.45 2.11L8.09 9.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45 12.84 12.84 0 002.81.7A2 2 0 0122 16.92z" stroke="#2563eb" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" fill="none"/>
                        </svg>
                      </div>
                    </div>
                  )}
